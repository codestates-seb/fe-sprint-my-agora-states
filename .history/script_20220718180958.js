...
const convertToDiscussion = (obj) => {
  ...
  const discussionAnswered = document.createElement("div");  // div 요소 생성
    ...
    const discussionAnsweredContent = docuemnt.createElement("p"); // p 요소 생성
    discussionAnsweredContent.className = "discussion__answered" // 클래스 이름 지정

    discussionAnswered.appendChild(discussionAnsweredContent);
  ...
  console.log(discussionAnswered);
