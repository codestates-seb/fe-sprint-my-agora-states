...
const convertToDiscussion = (obj) => { // 전달인자 obj , obj는 각각의 객체
  ...
  answerCheck.className = "material-symbols-outlined"
  answerCheck.textContent = obj.answer ? "check_box" : "check_box_outline_blank"; // 삼항연산자 조건문 obj.answer 두고 참일때 체크있는박스, 거짓일때 체크없는박스
