...
const convertToDiscussion = (obj) => {
  ...
  smallWrapper.className = "discussion__smallwrapper";
  ...
  discussionContent.append(contentTitle, discussionAnswered);

  smallWrapper.append(avatarWrapper, discussionContent);

  li.append(smallWrapper, contentInfo);
  return li;
};
...
const paginationLimit = 10; // 페이지 당 보여줄 게시물 개수
