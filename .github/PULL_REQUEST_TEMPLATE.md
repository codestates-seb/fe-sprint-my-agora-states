...
아래 예시를 지우고, 자신의 과제 시연 화면을 추가합니다.
 ...
 ![최연수_아고라스테이츠.png](../최연수_아고라스테이츠.png)
...
> 자바스크립트 전체적으로 구현이 어려웠습니다.<br/>
> 모르는 개념들을 찾고 익히느라 시간이 오래걸려서 욕심에 비해 완성도가 떨어진게 아쉽습니다.<br/>
> 이후에 시간을 더 내서 CSS, JS: pagination까지 차차 완성하려고 합니다.

### 도움을 받고 싶은 부분

> submit이 왜 안되는지 모르겠어요.
