...
- [ ] 디스커션 유지 기능
    ...
    -> 새 디스커션이 로컬스토리지에 저장되고 콘솔로 확인되나 새로고침시 사라져서 실패.

### My Own Self Checklist

자신이 추가로 더 구현한 기능이 있으면 아래 적어주세요.

- [v] 새 디스커션 추가 시 알림메세지 표시.
- [v] 새 디스커션 추가 시 작성자명 반영.
- [v] 새 디스커션 추가 시 질문내용 콘솔창에 띄워줌.(hover시 화면에 보이게 하려고 했으나 실패..)
- [v] 제목 폰트색상 그라데이션 적용.
- [v] 새 디스커션 등록시 작성자명, 제목, 질문내용 모두 입력시에만 새로운 질문 등록 가능. 미입력 항목이 있을 시 alert메세지 송출.
- [v] 제목 텍스트에니메이션 자바스크립트로 구현.
