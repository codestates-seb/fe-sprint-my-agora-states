...
- [x] 디스커션 유지 기능
    - [x] LocalStorage에 대해서 스스로 학습하고, 새롭게 추가하는 Discussion이 페이지를 새로고침해도 유지되도록 제작합니다.
        - 제출 버튼을 누르면 기존 데이터 배열에 추가하고, 변경된 배열을 로컬스토리지에 저장합니다.
        - 새로고침 시 로컬스토리지에서 저장된 값을 가져오고 만일 null값을 가지고 있다면 기존의 data값으로, null이 아니라면 갱신된 배열로 화면에 렌더링 합니다. 

### My Own Self Checklist

자신이 추가로 더 구현한 기능이 있으면 아래 적어주세요.
- [x] 작성일 기준 정렬
- [x] 질문 작성 시 마지막 페이지로 이동
