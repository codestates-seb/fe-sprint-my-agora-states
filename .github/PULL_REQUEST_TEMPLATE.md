...
https://kanglaeheon.github.io/fe-sprint-my-agora-states/
...
> flickering이 조금 있지만, 새로고침 없이 DOM 조작되도록 무난하게 구현한 것 같습니다.

### 구현하고 싶었는데 하지 못한 아쉬운 기능

> LocalStorage에 데이터를 저장하고 불러오게 하고 싶었는데 시간 관계상 미구현

### 도움을 받고 싶은 부분

> LocalStorage에 데이터를 저장하고, 수정하는 것은 가능했습니다.
  하지만, 새로고침 시 데이터가 꼬이는 문제가 있거나, 
  직접 로컬스토리지에 있는 데이터를 불러오니 undefined가 떴습니다.
  JSON을 다루는 요령이 부족했던 것 같고, 공부가 필요할 것 같습니다.
