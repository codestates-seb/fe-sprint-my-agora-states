...
- [✅] 게시물 삭제 기능
  - [✅] 게시물 삭제버튼을 누르면 해당 게시물 삭제
  - [ ] 해당 게시물 삭제시 data와 해당 게시물 동일한 값이 배열에도 함께 삭제
- []
- []
...
![image](/fe-sprint-my-agora-states/ezgif.com-gif-maker.gif)
...
> 페이지네이션 기능과 , 디스커션 유지 기능
> 해당 게시물 삭제 버튼시 같은 data 배열 값도 삭제 기능

### 도움을 받고 싶은 부분

> 해당 게시물 삭제 버튼시 data 안에 있는 값과 비교하고싶은데 어떤걸로 비교 할 수 있을까요?
