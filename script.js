...
const convertToDiscussion = (obj) => {
  ...
  const discussionContentATag = document.createElement("a");
  discussionContentATag.href = obj.url;
  discussionContentATag.textContent = obj.title;
  discussionContentH2.append(discussionContentATag);
  //h2, a 합침

  const discussionContentInform = document.createElement("div");
  discussionContentInform.className = "discussion__information";
  discussionContentInform.textContent = `${obj.author} / ${new Date(
    obj.createdAt
  ).toLocaleString()}`;
  discussionContent.append(discussionContentH2, discussionContentInform);
  //content 안에 h2 a div 합침

  const discussionAnswered = document.createElement("div");
  discussionAnswered.className = "discussion__answered";
  const discussionContentPP = document.createElement("p");
  discussionContentPP.textContent = obj.answer ? "☑" : "☒";
  discussionAnswered.append(discussionContentPP);
...
let imgArray = {
  1: "https://cdn.pixabay.com/photo/2014/03/24/17/19/teacher-295387__340.png",
  2: "https://cdn.pixabay.com/photo/2017/02/23/13/05/avatar-2092113__340.png",
  3: "https://cdn.pixabay.com/photo/2022/09/13/19/54/doll-7452766__340.png",
  4: "https://cdn.pixabay.com/photo/2022/08/03/08/33/woman-7362147__340.jpg",
  5: "https://cdn.pixabay.com/photo/2017/03/01/22/18/avatar-2109804__340.png",
};
