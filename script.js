...
const convertToDiscussion = (obj) => {
  ...
  //me: 아바타 프로필 사진이 들어갈 <img> 요소 추가
  //src, alt 속성을 agoraDiscussions의 첫 번째 요소에 있는 데이터로 넣어줌
...
const avatarImg = document.createElement('img');
  ...
  contentInfo.textContent = `${obj.author} / ${new Date(obj.createAt).toLocaleString()}`
...
form.addEventListener('submit', (event) => {
  ...
  // 하나의 객체를 만들어서 convertToDiscussion 함수에 넣어서 li로 만든 다음 ul요소에 append 해준다
