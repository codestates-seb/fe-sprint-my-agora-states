...
const convertToDiscussion = (obj) => {
  ...
  if (obj.answer === null) {
    ...
    discussionAnswered.className = "discussion__answered completed";
  }
...
const newDiscussionAuthor = document.querySelector(
  "div.form__input--name>input"
);
const newDiscussionTitle = document.querySelector(
