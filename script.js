...
const convertToDiscussion = (obj) => {
  ...
  if (obj.answer === null) {
    discussionAnswered.classList.add('hide');
  }
...
const addNewBtn = document.querySelector('.floating');
const addNewFloat = document.querySelector('.form__container');
let isOpened = false;
addNewBtn.addEventListener('click', ()=> {
  if (isOpened){
    addNewFloat.classList.add('hide');
    addNewBtn.classList.remove('black');
    isOpened = false;
  } else {
    addNewFloat.classList.remove('hide');
    addNewBtn.classList.add('black');
    isOpened = true;
  }
})