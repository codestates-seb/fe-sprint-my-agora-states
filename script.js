...
const convertToDiscussion = (obj) => { //input: agorastates[0], [1], ...
  ...
  const discussion__checked = document.createElement('p');
  discussion__checked.textContent = obj.answer ? '☑' : '⊠';

  discussionContent.append(discussionTitle, discussionInfo);
  discussionAnswered.append(discussion__checked);
...
form.addEventListener('submit', (event) =>{
  ...
  const obj = {
    ...
    answer: {
      ...
      avatarUrl: "https://dribbble.com/shots/4166422-User-icon"
    },
    bodyHTML:
  ...
  // 그거 또 render 함수에 넣어서 브라우저에 렌더링 -> 맨 앞으로
