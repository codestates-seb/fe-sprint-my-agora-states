...
const textbox = form.querySelector(".form__itextbox > textarea");

//submit을 클릭하면 자료를 가져옴.
form.addEventListener("submit", (event) =>{
  event.preventDefault() ; //submit 이벤트 사용시 꼭 같이 사용해줘야함.
  ...
  author.value = "";
  newTitle.value = "";
  form.querySelector(".form__textbox > textarea").value = "";
