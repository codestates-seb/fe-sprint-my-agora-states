...
const convertToDiscussion = (obj) => {
  ...
  const titleAnckor = document.createElement('a');

  contentTilte .className = 'discussion__title';
  titleAnckor.textContent = obj.title;
  titleAnckor.href = obj.url;

  contentTilte.append(titleAnckor);
...
form.addEventListener('submit', (event) => {
  ...
  // 그걸 다시 render 함수에 넣어 브라우저에 랜더링 > 맨아픙로
