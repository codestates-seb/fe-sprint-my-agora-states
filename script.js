...
const convertToDiscussion = (obj) => {
  ...
  const discussionContent2 = document.createElement("h2");
  discussionContent2.className = "discussion__title"
  discussionContent.append(discussionContent2);
  

  const discussionContent3 = document.createElement("a");
  discussionContent3.href = obj.url
  discussionContent3.textContent = obj.title
  discussionContent2.append(discussionContent3);

  const discussionContent4 = document.createElement("div");
  discussionContent4.className = "discussion__information"
  discussionContent4.textContent = `${obj.author} / ${new Date(obj.createdAt).toLocaleString()}`
  discussionContent.append(discussionContent4);

  

  
   
  const discussionAnswered2 = document.createElement("p");
  
  discussionAnswered.append(discussionAnswered2);

  discussionAnswered2.textContent = obj.answer === null ?  " " : "☑";
...
const authora = document.querySelector('.form__input--name > input');
const titlea = document.querySelector('.form__input--title > input');
const textAreaa = document.querySelector('.form__textbox > textarea')
