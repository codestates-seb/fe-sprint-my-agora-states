...
const convertToDiscussion = (obj) => {
  ...
  contentInfo.textContent = `${obj.author} / ${new Date(obj.createdAt).toLocaleTimeString()}`  // discussionContent.append(discussionTitle, discussionInfo);
  ...
  //submit 클릭하면 자료를 가져오도록

  form.addEventListener("submit", (event) => {
    event.preventDefault();
    
    const obj = {  //제출 눌렀을 때 새로운 객체로 입력되도록 만들어주기
    ...
    agoraStatesDiscussions.unshift(obj); //submit 누르면 맨앞에 추가
