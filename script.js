...
const convertToDiscussion = (obj) => {
  ...
  discussionInform.textContent = `${obj.author} / ${new Date(obj.createAt || Date.now).toLocaleTimeString()}`
...
//agoraStatesDiscussions 객체추가
  agoraStatesDiscussions.unshift(obj);
// 화면 다 지우고
  while (ul.firstChild) {
  ul.removeChild(ul.firstChild);
//다시 agoraStatesDiscussions기반으로 화면 보여주기
  render(ul);
  }
})