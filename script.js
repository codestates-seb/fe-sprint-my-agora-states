...
const convertToDiscussion = (obj) => {
  ...
  const titleAbchor = document.createElement("a");
  contentTitle.className = "discussion_title";
  titleAbchor.textContent = obj.title;
  titleAbchor.href = obj.url;

  contentTitle.append(titleAbchor);
  ...
  contentInfo.className = "discussiom__information";
...
const textArea = document.querySelector(".form__textbox > text");
