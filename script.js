...
const convertToDiscussion = (obj) => {
  ...
  discussionTitleUrl.target = '_blank';
...
const textArea = document.querySelector('.form__textbox > input');
...
form.addEventListener('submit', (event) => {
  ...
  const obj = {
    ...
    avatarUrl:
      "https://yt3.ggpht.com/ytc/AMLnZu8gMYcH-tMw0f1N2eQ1CRV-HYPVo83clhkr1Pyv1g=s900-c-k-c0x00ffffff-no-rj",
  };

  //객체를 converToDiscussion에 넣어서 DOM으로 변환한다
  agoraStatesDiscussions.unshift(obj);
  console.log(agoraStatesDiscussions);

  //그걸 또 render함수에 넣어서 브라우저에 렌더링한다 (맨 앞으로)
