...
const textArea = document.querySelector('.form__textbox > #story');
...
form.addEventListener('submit',(event) => {
  ...
  console.log(agoraStatesDiscussions);
  //배열에 추가하기
  //그 그객체를 convertTODiscussion에 넣어서 DOM으로 변환
  // 그걸 또 다시 render 함수에 넣어서 브라우저에 렌더링
...
document.querySelector('.form__container').removeAttribute('style');