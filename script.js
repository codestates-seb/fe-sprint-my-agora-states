...
submitBtn.onclick = ()=> {
  ...
  const seq = "guest"+(Math.floor(Math.random() * 10000) + 10000).toString().substring(1);
const date=new Date();
  const time=date.getFullYear()+"-"+date.getMonth()+"-"+date.getDate()+"-"+date.getDay()+"T"+date.getHours()+":"+date.getMinutes()+"z";
