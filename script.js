...
//데이터값 받아오기 안됨
// const newInputButton = document.querySelector("#button");
// const newAuthor = document.querySelector("#newAuthor"); //name
// const newTitle = document.querySelector("#newTitle");   //title
// const time = new Date()
// const newObj ={author : newAuthor, createdAt : time, title : newTitle, avatarUrl: "https://avatars.githubusercontent.com/u/79903256?s=64&v=4"};
// Li.append(avatarWrapper, discussionContent, discussionAnswered)
