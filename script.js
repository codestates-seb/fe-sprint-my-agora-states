async function getData() {
  ...
  //   //새로운 질문을 localstarage에 저장
  // localStorage.setItem('discussion', JSON.stringify(agoraStatesDiscussions[0]))
  // const newContent = JSON.parse(localStorage.getItem('discussion'));
