...
const convertToDiscussion = (obj) => { //객체를 매게변수로 받음
 ...
 avatarImg.alt="avatar of"+obj.author;  //이미지가 깨질수도 있어 alt도 필수로 넣음
...
checked.className="dicussion__answered";
...
const render = (element) => {
  //더미테이터의 길이만큼, 더미데이터안에 있는 모든 요소를 탐색
  for (let i = 0; i < agoraStatesDiscussions.length; i += 1) {
    // i번째 요소를 converToDiscussion에 전달해서 결과를 ul에 append
...
const textArea=document.querySelector('.form__textbox');
...
const obj={
  id: "unique number",
    ...
    avatarUrl:
      "https://avatars.githubusercontent.com/u/9"
