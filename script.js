...
const convertToDiscussion = (obj) => {
  ...
  'https://em-content.zobj.net/source/skype/289/check-mark-button_2705.png' : 
  'https://em-content.zobj.net/source/skype/289/cross-mark_274c.png';
...
// const image = document.querySelector('input#profile');
...
form.addEventListener('submit', (event) => {
  // 제출하면서 새로고침이 발생하는 것을 막아준다.
  event.preventDefault();

  // 하나의 객체를 만들어서 convertToDiscussion함수에 넣어서 li로 만든 다음 ul 요소에 append한다.
  const newDiscussion = {
    id: "unique value",
    createdAt: new Date(),
    title: title.value,
  ...
  // append를 하면 맨 뒤로 들어가니까 prepend를 해서 맨 위에 데이터가 쌓이게 한다.
